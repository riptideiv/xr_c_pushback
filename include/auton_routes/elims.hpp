...
namespace auton {
    void leftElims() {
        ...
        pid::turnToPoint(-30.5, 12.5, 500);
        intk::stop();
        pid::moveToPoint(-30.5, 12.5, 1500, {.earlyExitRange = 15});
        pid::moveToPoint(-30.5, 12.5, 1500, {.maxSpeed = 20, .earlyExitRange = 4});
        ...
        pros::delay(250);
        intk::intake(100);
        pid::moveToPoint(-29, 0.27722, 1000, {.straight = true, .earlyExitRange = 3});
    ...
    void rightElims() { // get group of 3 balls
        ...
        // get group of 3 balls
        pid::moveToPoint(0, 12.0, 1000, {.straight = true, .maxSpeed = 60, .earlyExitRange = 4});
        intk::intake(100);
        pid::swingToHeading(45, 700, false, {.maxSpeed = 60});
        pid::moveToPoint(4.54353, 31, 750, {.straight = true});
        ...
        // go to match loader
        bot::setTopDescore(true);
        pid::turnToPoint(34.7, 21, 700);
        intk::stop();
        pid::moveToPoint(34.7, 21, 1500, {.earlyExitRange = 15});
        pid::moveToPoint(34.7, 21, 1500, {.maxSpeed = 20, .earlyExitRange = 4});
        pid::driveWait(0.02, 0.02, 150);
        pid::turnToHeading(180, 500);
        ...
        pros::delay(250);
        intk::intake(100);
        pid::moveToPoint(40.5, 5, 1000, {.straight = true, .earlyExitRange = 4});
        pid::driveWait(0.25, 0.25, 800);

        // score in high goal
        bot::toggleMatchLoader();
        pid::moveToPoint(40.8, 37, 1000, {.forwards = false, .earlyExitRange = 3});
        intk::scoreHigh(100);
        pid::turnToHeading(180, 700);
        for (int i = 0; i < 200 && !intk::wrongColorDetected(); i++) {
            pros::delay(10);
